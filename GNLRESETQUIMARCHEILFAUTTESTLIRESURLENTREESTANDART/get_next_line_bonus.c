...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/03/14 14:09:17 by alopez            #+#    #+#             */
/*   Updated: 2020/03/14 14:15:56 by alopez           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			ft_line(char *str[OPEN_MAX], char **line, int ret, int fd)
{
	int		i;
...
char		*ft_rest(char *str[OPEN_MAX], int fd)
{
	int		i;
	int		str_len;
	char	*tmp;
...
char		*ft_read_line(char *str[OPEN_MAX], int fd, int *ret)
{
